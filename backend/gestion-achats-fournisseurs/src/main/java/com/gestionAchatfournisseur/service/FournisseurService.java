...
public class FournisseurService {
    ...
    public Fournisseur updateFournisseur(Long id, Fournisseur fournisseurDetails) {
        Fournisseur fournisseur = fournisseurRepository.findById(id).orElseThrow(
                () -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Fournisseur non trouvé")
        );
    ...
    public List<EvaluationFournisseur> evaluerFournisseurs() {
        ...
        List<EvaluationFournisseur> evaluations = new ArrayList<EvaluationFournisseur>();
        ...
        for (Fournisseur fournisseur : fournisseurs) {
            ...
            if (historiques != null && !historiques.isEmpty()) {
                ...
                for (HistoriqueAchats historique : historiques) {
                    somme = somme + historique.getDelaiLivraison();
                }
